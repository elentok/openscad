...
kb_size_x = is_quefrency ? 194 : 199;
case_size_x = kb_size_x + case_kb_padding * 2;

kb_row_heights = is_quefrency ? [ 20.7, 17.5, 19.1, 20.7, 19.5 ]
                              : [ 20.7, 21.7, 19.1, 19.1, 20.7, 19.5 ];
...
// [ [x, width], [x,width], ...]
kb_bottom_row_spaces = [[ 141.3, 7.5 ]];
...
case_usb_hole_start_from_left = is_quefrency ? [ 18, 114 ] : [ 36, 123 ];
